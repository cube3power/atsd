...
The override table provides a convenient way to enumerate exceptions to the default condition evaluated by the rule. It allows you to minimize the number of rule variations created due to minor differences in the thresholds applicable to specific entity groups, entities or tags.
