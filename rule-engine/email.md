...
Messages generated by the rule engine are handled by the the built-in [mail client](../administration/mail-client.md) which is accessible on the **Settings > Mail Client** page.
