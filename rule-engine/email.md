...
Messages generated by the rule engine are handled by the the built-in [Mail Client](../administration/mail-client.md) which is configurable on the **Settings > Mail Client** page.
