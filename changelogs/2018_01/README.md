...
-----|-------------|---------|----------------------
4940 | rule engine | Feature | Rule Engine: add administrative setting to control On Cancel behavior.
...
4910 | rule engine | Bug | Implement executeSqlQuery function to return result of SQL query.
4908 | rule engine | Feature | Create rule from message search page.
4901 | rule engine | Feature | Implement utility function to extract host, port, protocol from url.
4900 | rule engine | Feature | Implement lookup function getEntityId.
4899 | rule engine | Feature | Implement trim text function to remove leading and trailing non-printable characters.
4897 | rule engine | Feature | Implement property link function for entity.
...
4879 | rule engine | Feature | Add support for orb-tags in email and web notifications.
...
4863 | rule engine | Feature | Default value for `lookup` function.
4861 | api-rest | Feature | Webhook: set command time from (milli)seconds.
4858 | rule engine | Feature | Add unquote function.
...
4854 | rule engine | Feature | Implement new math functions.
...
4844 | data-in | Support | Add instruction to configure an outgoing webhook.
4838 | portal | Bug | Rule portal: series label not resolved and last value not correct.
4833 | rule engine | Feature | Implement Web Notifications for Microsoft Azure.
4832 | rule engine | Feature | Implement Web Notifications for Google Cloud Platform.
...
4746 | api-rest | Feature | Data API: add "order" field to "rate" function.
